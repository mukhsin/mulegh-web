    ...
    <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/customer/'.$customer->id.'/edit') }}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group{{ $errors->has('nomor') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="nomor" value="{{ $customer->nomor }}" readonly="" required="">
                    ...
                    <div class="form-group{{ $errors->has('nama') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="nama" value="{{ $customer->nama }}" required="" autofocus="">
                    ...
                    <div class="form-group{{ $errors->has('alamat') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-8">
                            ...
                            <textarea class="form-control" name="alamat" required="">{{ $customer->alamat }}</textarea>
                    ...
                    <div class="form-group{{ $errors->has('telepon') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="telepon" value="{{ $customer->telepon }}" required="">
