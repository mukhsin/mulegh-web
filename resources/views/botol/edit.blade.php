    ...
    <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/botol/'.$botol->id.'/edit') }}">
                    {{ csrf_field() }}

                    <input type="hidden" name="_method" value="put">
                    <input type="hidden" name="id" value="{{ $botol->id }}">
                    ...
                    <div class="form-group{{ $errors->has('tipe') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="tipe" value="{{ $botol->tipe }}" required="" autofocus="">
                    ...
                    <div class="form-group{{ $errors->has('harga') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="harga" value="{{ $botol->harga }}" required="">
