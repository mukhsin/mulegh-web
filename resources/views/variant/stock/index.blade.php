        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <span class="table-title">
                    Stock Variant <b>{{ $variant->nama }}</b>
                </span>
                <a href="{{ url('/variant/'.$variant->id.'/stock/new') }}">
                    <button type="button" name="add" class="btn btn-sm btn-success pull-right middle">
                        <i class="fa fa-btn fa-plus"></i>
                        Tambah Stock
                    </button>
                </a>
                {{-- <form class="form-horizontal col-md-3 pull-right" role="form" method="GET" action="{{ url('/variant/'.$variant->id.'/stock/search') }}" name="form-search">
