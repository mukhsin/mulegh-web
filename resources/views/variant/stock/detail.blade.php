...
@section('content')
    <div class="col-md-12">
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/variant') }}">Customer</a></li>
            <li><a href="{{ url('/variant/'.$variant->idvariant.'/stock') }}">Stock</a></li>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <span class="table-title">
                    Detail Stock Variant <b>{{ $variant->variant_nama }} {{ $stock->stock_date }}</b>
                </span>
            </div>
